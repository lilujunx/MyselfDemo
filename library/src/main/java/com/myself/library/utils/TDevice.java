...
/**
 *
 *可以获取屏幕宽高，dp2px，获取包名，版本号，软键盘手动开启关闭
 *
 *
 */
...
public class TDevice {
    ...
    public static TDevice mTDevice;

    private TDevice(Application app) {
        this.mApp = app;
    }
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return mApp.getResources().getDisplayMetrics();
    }
    ...
    *    当前是否 为竖屏
    * */
    public static boolean isPortrait() {  //Portrait : 竖屏
        return mApp.getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = mApp.getResources().getConfiguration().screenLayout;
    ...
    public static boolean isWifiOpen() {
        ConnectivityManager cm = (ConnectivityManager) mApp
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) mApp
                .getSystemService(Context.CLIPBOARD_SERVICE);
        clip.setText(string);
        Toast.makeText(mApp, "已复制到粘贴板", Toast.LENGTH_SHORT).show();
    }
