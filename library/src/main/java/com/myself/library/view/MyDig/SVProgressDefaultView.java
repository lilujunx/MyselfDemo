...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private void initViews() {
        View mInflate = LayoutInflater.from(getContext()).inflate(R.layout.view_svprogressdefault, this, true);
        ivBigLoading = (ImageView) mInflate.findViewById(R.id.ivBigLoading);
        ivSmallLoading = (ImageView) mInflate.findViewById(R.id.ivSmallLoading);
        circleProgressBar = (SVCircleProgressBar) mInflate.findViewById(R.id.circleProgressBar);
        tvMsg = (TextView) mInflate.findViewById(R.id.tvMsg);
    }
